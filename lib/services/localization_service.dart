...
class LocalizationService extends ChangeNotifier {
  ...
  static final Map<String, Map<String, String>> _translations = {
    ...
    'मराठी': {
      ...
      'activity_summary': 'क्रिया सारांश',
      'in_progress': 'प्रगतीपथावर',
      'reported': 'नोंदवले',
      'resolved_label': 'निराकरण',
    ...
    'தமிழ்': {
      ...
      'failed_to_load_profile': 'சுயவிவரம் ஏற்றுவதில் தோல்வி',
      'personal_details': 'தனிப்பட்ட விவரங்கள்',
      'mobile': 'கைபேசி',
      'gender': 'பாலினம்',
      'age': 'வயது',
      'member_since': 'இலக்கம்',
      'activity_summary': 'செயல்பாட்டு சுருக்கம்',
      'reported': 'அறிக்கை',
      'resolved_label': 'தீர்ப்பு',
      'ok': 'சரி',
      'save': 'சேமி',
      'submit': 'சமர்ப்பி',
      'done': 'முடிந்தது',
    ...
    'తెలుగు': {
      ...
      // Common
      'loading_profile': 'ప్రోఫైల్ లోడ్ అవుతోంది...',
      'failed_to_load_profile': 'ప్రోఫైల్ లోడ్ చేయడంలో విఫలం',
      'personal_details': 'వ్యక్తిగత వివరాలు',
      'mobile': 'మొబైల్',
      'gender': 'లింగం',
      'age': 'వయస్సు',
      'member_since': 'సభ్యురాలిగా ఈ తేదీ నుండి',
      'activity_summary': 'క్రియాశీలత సారాంశం',
      'reported': 'రిపోర్టెడ్',
      'resolved_label': 'పరిష్కరించబడిన',
      'save': 'సేవ్ చేయి',
      'submit': 'సబ్మిట్',
      'done': 'పూర్తయింది',
      'yes': 'అవును',
